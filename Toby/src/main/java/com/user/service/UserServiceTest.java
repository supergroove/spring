...
import static com.user.service.UserServiceImpl.MIN_LOGCOUNT_FOR_SILVER;
import static com.user.service.UserServiceImpl.MIN_RECCOMEND_FOR_GOLD;
...
//@Transactional
//@TransactionConfiguration(defaultRollback=false) // 커밋하고 싶은 메소드에만 @Rollback
